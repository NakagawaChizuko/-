...
function ensureViewerInitialized() {
  ...
  try {
    ...
    if ((_viewer3d$renderer = viewer3d.renderer) !== null && _viewer3d$renderer !== void 0 && _viewer3d$renderer.domElement) {
      ...
      viewer3d.renderer.domElement.addEventListener("pointerup", handleViewerPointerEnd);
      viewer3d.renderer.domElement.addEventListener("pointercancel", handleViewerPointerEnd);
...
function openPdfPrintWindow(_ref16) {
  ...
  var htmlText = "\n    <!doctype html>\n    <html lang=\"ja\">\n      <head>\n        <meta charset=\"utf-8\" />\n        <meta name=\"viewport\" content=\"width=device-width, initial-scale=1\" />\n        <title>".concat(safeTitle, "</title>\n        <style>").concat(buildPdfPrintStyles(pageSize), "</style>\n        <style>\n          .pdf-preview-controls { position: sticky; top: 0; z-index: 1000; display: flex; justify-content: flex-end; padding: 10px; background: rgba(255,255,255,.96); border-bottom: 1px solid #cbd5e1; }\n          .pdf-preview-controls button { appearance: none; border: 0; border-radius: 8px; padding: 10px 16px; background: #b42318; color: #fff; font: inherit; font-size: 14px; font-weight: 700; cursor: pointer; }\n          @media print { .pdf-preview-controls { display: none !important; } }\n        </style>\n      </head>\n      <body>\n        <div class=\"pdf-preview-controls\">\n          <button type=\"button\" onclick=\"if(window.opener&&!window.opener.closed){window.close();}else if(history.length>1){history.back();}else{window.close();}\">PDF画面を閉じる</button>\n        </div>\n        ").concat(safeBody, "\n      </body>\n    </html>\n  ");
